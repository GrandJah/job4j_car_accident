    ...
    <form action="<c:url value='/save'/>" method='POST'>
        <table class="table">
            ...
            <tr class="row justify-content-center">
                ...
                <td class="col-1"></td>
                <td class="col-8"><input id="name" type='text' name='name'></td>
            </tr>
            <tr class="row justify-content-center">
                <th scope="row" class="col-3"><label for="address">Адрес:</label></th>
                <td class="col-1"></td>
                <td class="col-8"><input id="address" type='text' name='address'></td>
            </tr>
            <tr class="row justify-content-center">
                <th scope="row" class="col-3"><label for="text">Описание:</label></th>
                <td class="col-1"></td>
                <td class="col-8"><input id="text" type='text' name='text'></td>
            </tr>
            <tr class="row justify-content-center">
